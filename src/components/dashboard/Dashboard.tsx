  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8 pb-8">
      ...
      <motion.div variants={item} className="flex flex-wrap gap-3">
        <Link
          to="/dashboard/qr"
          className="inline-flex items-center gap-2 rounded-xl bg-accent-green px-6 py-3 text-sm font-semibold text-white hover:bg-accent-green-hover transition-all duration-200 shadow-lg shadow-accent-green/20 hover:shadow-accent-green/30 hover:scale-[1.02]"
        >
        ...
        <Link
          to="/register"
          className="inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-6 py-3 text-sm font-semibold text-primary hover:bg-white/10 hover:border-white/20 transition-all duration-200"
        >
          Register
        </Link>
      </motion.div>
