import{a as v,b as l,w as ye,i as Je}from"./lit-element-aFLxC3kZ.js";import{n as c,r as d,o as x}from"./class-map-JaqmVrhY.js";import{n as P,A as g,O as S,h as m,e as w,a as Re,E as T,R as f,r as W,y as Ke,F as re,x as ie,H as ut,t as j,u as Y,T as Be,d as ve,M as et,G as tt,I as it,l as nt,C as te,J as ht,K as pt,L as De}from"./core-DSuXAPTC.js";import{c as y,U as Q}from"./index-DXZzHaIm.js";import{Q as ft}from"./browser-FDZg1MWl.js";import{e as Ne,n as Me}from"./ref-B5NCMojs.js";import"./index-BvJuXSID.js";import"./browser-3gzE7ErT.js";import"./index-D_sE5vDe.js";import"./async-directive-JXnEvIGu.js";var be=function(e,t,n,o){var r=arguments.length,i=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,o);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(r<3?s(i):r>3?s(t,n,i):s(t,n))||i);return r>3&&i&&Object.defineProperty(t,n,i),i};let se=class extends v{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=P.state.connectors,this.count=g.state.count,this.filteredCount=g.state.filteredWallets.length,this.isFetchingRecommendedWallets=g.state.isFetchingRecommendedWallets,this.unsubscribe.push(P.subscribeKey("connectors",t=>this.connectors=t),g.subscribeKey("count",t=>this.count=t),g.subscribeKey("filteredWallets",t=>this.filteredCount=t.length),g.subscribeKey("isFetchingRecommendedWallets",t=>this.isFetchingRecommendedWallets=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){const t=this.connectors.find(b=>b.id==="walletConnect"),{allWallets:n}=S.state;if(!t||n==="HIDE"||n==="ONLY_MOBILE"&&!m.isMobile())return null;const o=g.state.featured.length,r=this.count+o,i=r<10?r:Math.floor(r/10)*10,s=this.filteredCount>0?this.filteredCount:i;let a=`${s}`;this.filteredCount>0?a=`${this.filteredCount}`:s<r&&(a=`${s}+`);const h=w.hasAnyConnection(Re.CONNECTOR_ID.WALLET_CONNECT);return l`
      <wui-list-wallet
        name="Search Wallet"
        walletIcon="search"
        showAllWallets
